  ...
  { edgesOut = \case
      False ->
        [ Edge
            ...
            , update = UKeep
            , output =
                [ pack inCtorBegin wcAB
                    (OFCons (TInpCtorField inCtorBegin (#a :: Index '[ '("a", Int), '("b", Int), '("c", Int) ] Int))
                       (OFCons (TInpCtorField inCtorBegin (#b :: Index '[ '("a", Int), '("b", Int), '("c", Int) ] Int)) OFNil))
                , pack inCtorBegin wcBC
                    (OFCons (TInpCtorField inCtorBegin (#b :: Index '[ '("a", Int), '("b", Int), '("c", Int) ] Int))
